<template>
    <div>
        <h1 style="margin-left: 12px">阿迪达斯图片下载</h1>
        <el-form ref="form" :model="form" label-width="80px">
            ...
            <el-form-item>
                ...
                <el-button type="primary" @click="getImageUrl">下载已选择图片</el-button>
                <el-button type="primary" @click="getImageUrl">下载全部图片</el-button>
            </el-form-item>
        </el-form>

        <showImage :imageInfo="imageInfo" :imgData="imgData"></showImage>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            getImageUrl() {
                ...
                switch (method) {
                    case '通道一':
                        this.$http.post("/api/adidas/get").then(res => {
                                console.log(res)
                            })
                        break
                    case '通道二':
